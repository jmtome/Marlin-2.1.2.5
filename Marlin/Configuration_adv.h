 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 200       // (seconds) - much longer for slow system
  #define THERMAL_PROTECTION_HYSTERESIS 50     // (°C) - handle thermistor instability at 235°C
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  120              // (seconds) - longer for slow heating
  #define WATCH_TEMP_INCREASE 1               // (°C) - smaller increase required
#endif
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 2
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 150*60, 150*60, 8*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel - FASTER
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     45  // (mm/s) Unload filament feedrate. This can be pretty fast. (was 25)
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        35  // (mm/s^2) Lower acceleration may allow a faster feedrate. (was 50)
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  30  // (mm/s) Load filament feedrate. This can be pretty fast. (was 25)
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     30  // (mm/s^2) Lower acceleration may allow a faster feedrate. (was 25)
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   100  // (mm) Load length of filament, from extruder gear to nozzle. (was 60)
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        5  // (mm/s) Extrude feedrate (after loading). Lowered for 0.4mm nozzle.
  #define ADVANCED_PAUSE_PURGE_LENGTH        300  // (mm) Length to extrude after loading and per 'Purge More'.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT        5  // (mm) Unload initial retract length. (was 13)
  #define FILAMENT_UNLOAD_PURGE_DELAY       2000  // (ms) Delay for the filament to cool after retract. (was 5000)
  #define FILAMENT_UNLOAD_PURGE_LENGTH         5  // (mm) An unretract is done, then this length is purged. (was 12)
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      15  // (mm/s) feedrate to purge before unload. (was 35)
